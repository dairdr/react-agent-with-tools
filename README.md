...
<div align="center">
  <img src="./static/studio_ui.jpg" alt="Graph view in LangGraph studio UI" width="75%" />
</div>
...
This project uses Python 3.12 and [uv](https://docs.astral.sh/uv/) for dependency management and virtual environment handling.
